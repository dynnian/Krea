                ...
                {isMobile ? (
                    ...
                    <div className="flex items-center justify-between px-4 py-2">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            >
                                {showMobileSearch ? (
                                    <X className="text-[#F3F3F1]" size={20} />
                                ) : (
                                    <Search
                    ...
                    <div className="flex items-center justify-between px-6 py-2">
                            ...
                            <nav className="flex items-center gap-6">
                                ...
                                >
                                    <div className="flex items-center gap-1">
                                        <span
                                            className={`text-lg font-medium transition-colors ${isHomeActive ? "text-[#8FB78E]" : "text-[#E3E2DE] group-hover:text-white"}`}
                                        >
                                            {t("navbar.home")}
                                        </span>
                                        <Home
                                            ...
                                            className={
                                                isHomeActive
                                                    ? "text-[#8FB78E]"
                                                    : "text-[#E3E2DE] group-hover:text-white"
                                            }
                                        />
                                    </div>
                                    {isHomeActive && (
                                ...
                                >
                                    <div className="flex items-center gap-1">
                                        <span
                                            className={`text-lg font-medium transition-colors ${isExploreActive ? "text-[#8FB78E]" : "text-[#E3E2DE] group-hover:text-white"}`}
                                        >
                                            {t("navbar.explore")}
                                        </span>
                                        <Search
                        ...
                        {isAuthenticated ? (
                            <div className="flex items-center gap-6">
                                <Link
                                    to="/messages"
                                    className={`transition-colors ${isMessagesActive ? "text-[#8FB78E]" : "text-[#E3E2DE] hover:text-white"}`}
                                >
                                ...
                                >
                                    <button className="flex items-center gap-3 group cursor-pointer bg-transparent border-0 p-1">
                                        ...
                                        <div className="hidden lg:flex flex-col items-start max-w-[150px]">
                                            <span
                                                className={`font-medium text-sm transition-colors truncate w-full text-left ${isProfileActive ? "text-[#8FB78E]" : "text-[#E3E2DE] group-hover:text-white"}`}
                                            >
                                                {user?.name}
                                            </span>
                                        </div>
                                        <ChevronDown
                                            size={16}
                                            className="text-[#E3E2DE] group-hover:text-white transition-colors"
                                        />
                                    </button>
                                </Popover>
                            </div>
                ...
                <div className="flex flex-col">
                    ...
                    {isAuthenticated ? (
                        ...
                        <div className="px-6 py-4">
                            <Link
                                to="/login"
                                className="flex items-center justify-center gap-2 w-full !bg-[#8FB78E] !text-[#1351AA] hover:!bg-[#a5c9a4] py-3 rounded-xl font-bold text-lg transition-colors"
                                onClick={() => setDrawerOpen(false)}
                            >
