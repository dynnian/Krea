namespace Krea.API.Tests.Integration {
    ...
    public sealed class UsersControllerIntegrationTests(PostgresContainerFixture postgres) {
        ...
        public async Task FollowAndUnfollow_ChangesDatabaseState() {
            ...
            int remaining =
                await TestDataSeeder.CountFollowsAsync(verifyScope.ServiceProvider, seeded.AdminId,
                    seeded.ArtistId);
        ...
        public async Task SearchUsers_ReturnsMatchingUsers() {
            ...
            HttpResponseMessage response =
                await host.Client.GetAsync("/api/users/search?query=art&page=1&pageSize=10");
        ...
        public async Task UploadMyProfilePicture_WithoutFile_ReturnsBadRequest() {
            ...
            using HttpRequestMessage request = IntegrationTestHost.CreateAuthenticatedRequest(
                HttpMethod.Post,
