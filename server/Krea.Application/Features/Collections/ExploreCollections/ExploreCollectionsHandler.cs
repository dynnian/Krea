namespace Krea.Application.Features.Collections.ExploreCollections {
        ...
        : IRequestHandler<ExploreCollectionsQuery, PaginatedList<CollectionExploreDto>>
    {
        ...
        public ExploreCollectionsHandler(ICollectionRepository repository)
        {
        ...
        {
            var result = await _repository.ExploreAsync(
                request.Search,
                request.SortBy,
                request.Page,
                request.PageSize,
            ...
            var items = result.Items.Select(c => new CollectionExploreDto
            {
                Id = c.Id,
                Title = c.Title,
