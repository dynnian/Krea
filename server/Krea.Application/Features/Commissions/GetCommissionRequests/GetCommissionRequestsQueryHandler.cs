namespace Krea.Application.Features.Commissions.GetCommissionRequests {
    ...
    public class GetCommissionRequestsQueryHandler(
        ...
        public async Task<IReadOnlyList<CommissionRequestDto>> Handle(GetCommissionRequestsQuery request,
            ...
            return requests.Select(r => new CommissionRequestDto(
                ...
                r.CreatedAt,
                r.UpdatedAt,
                new CommissionOfferingMinimalDto(r.Offering.Id, r.Offering.Title, r.Offering.BasePrice.Amount,
                    r.Offering.BasePrice.Currency),
