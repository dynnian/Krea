...
public class GetOfferingsQueryHandler(
    ...
    ILogger<GetOfferingsQueryHandler> logger)
    : IRequestHandler<GetOfferingsQuery, IReadOnlyList<CommissionOfferingDto>>
{
    public async Task<IReadOnlyList<CommissionOfferingDto>> Handle(GetOfferingsQuery request, CancellationToken cancellationToken)
    {
