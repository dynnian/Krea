...
namespace Krea.Infrastructure.Repositories {
    public sealed class InstanceConfigurationRepository : IInstanceConfigurationRepository {
        ...
        public InstanceConfigurationRepository(AppDbContext context) {
            _context = context;
        }
        ...
        public async Task AddAsync(InstanceConfiguration configuration, CancellationToken cancellationToken = default) {
