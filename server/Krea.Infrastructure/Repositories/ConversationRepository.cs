namespace Krea.Infrastructure.Repositories {
    ...
    public class ConversationRepository(AppDbContext context) : IConversationRepository {
        ...
        public async Task<Conversation?> GetDirectMessageBetweenAsync(Guid user1Id, Guid user2Id,
                                                                      CancellationToken cancellationToken = default) =>
            await context.Conversations
                         .Include(c => c.Participants)
                         .ThenInclude(p => p.User)
        ...
        public void Update(Conversation conversation) => context.Conversations.Update(conversation);

        public void Delete(Conversation conversation) => context.Conversations.Remove(conversation);
    }
}