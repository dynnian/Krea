namespace Krea.Infrastructure.Identity {
    ...
    public static class AdminSeeder {
        public static async Task SeedAsync(IServiceProvider services) {
            ...
            AdminUserOptions options = services.GetRequiredService<IOptions<AdminUserOptions>>().Value;
            ...
            AppUser? existingIdentity = await userManager.FindByEmailAsync(options.Email);
